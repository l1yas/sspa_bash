...
<head>
<meta charset="UTF-8">
<title>SSPA – Rapport d'Audit</title>
...
<h1>SSPA - Rapport d'Audit de Sécurité</h1>
<div class="subtitle">System & Security Posture Analysis</div>

<div class="card meta">
<b>Date :</b> $(date)<br>
<b>Cible :</b> ${TARGET:-Non spécifiée}
</div>
...
<div class="card">
<h2>Utilisateurs privilégiés</h2>
$USERS_RESULT
</div>

<div class="footer">
Rapport généré par <b>SSPA</b> – Script d’audit en lecture seule
</div>
